...
parser.add_argument('--model', default='CSARST',
                    help='model name')
...
# log specifications
parser.add_argument('--save', type=str, default='CSARST_RSCNN7X4',
...
# Option for CSARST
parser.add_argument('--back_projection_iters', type=int, default=15,
                    help='back projection iterations')
parser.add_argument('--en_depth', type=int, default=4,
                    help='the depth of encoder')
parser.add_argument('--de_depth', type=int, default=2,
